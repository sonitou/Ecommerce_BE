...
export class RoleRepo {
  ...
  async listRoleRepo(pagination: GetRolesQueryType): Promise<GetRolesResType> {
  ...
  async findByIdRoleRepo(id: number): Promise<RoleWithPermissionsType | null> {
  ...
  async deleteRoleRepo({ id, deletedById }: { id: number; deletedById: number }, isHard?: boolean): Promise<RoleType> {
    return isHard
